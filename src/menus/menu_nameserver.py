...
class MenuNameServer:
    ...
    def _view_logs_session_active(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The logs for the current session have been uploaded successfully.", LogType.UPLOAD, True)
    ...
    def _view_logs(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The logs have been uploaded successfully.", LogType.UPLOAD, True)
        print(all_logs)

    def _export_logs_to_csv(self):
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Exporting logs to CSV...", LogType.UPLOAD, True)
        try:
            self.access_coordinator.management_logs.export_logs_to_csv()
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Logs have been exported.", LogType.UPLOAD, True)
    ...
    def _add_whitelist(self):
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Adding an IP to the whitelist...", LogType.REQUEST, True)
        ...
        if is_valid_ip:
            ...
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, data.message, LogType.RESPONSE, True)
        else:
            print("The IP entered is not valid. Please enter a valid IP.")
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Invalid IP entered for whitelist.", LogType.ERROR, False)

    def _add_blacklist(self):
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Adding an IP to the blacklist...", LogType.REQUEST, True)
    ...
    def _view_whitelist(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The whitelist has been uploaded successfully.", LogType.UPLOAD, True)
    ...
    def _view_blacklist(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The blacklist has been uploaded successfully.", LogType.UPLOAD, True)
    ...
    def _remove_ip(self, type_list: NameListSecurity, ip: str):
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, f"Removing the IP {ip} from the {type_list.value}...", LogType.REQUEST, True)
        ...
        if opt_select.lower() != 'n' and opt_select.lower() != 'y' and opt_select != '':
            ...
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, response.message, LogType.RESPONSE, True)
    ...
    def _remove_whitelist(self):
        ...
        if len(whitelist):
            ...
            print("The whitelist is empty.")
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The whitelist is empty.", LogType.REQUEST, True)
    ...
    def _remove_blacklist(self):
        ...
        if len(blacklist):
            ...
            print("The blacklist is empty.")
            self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The blacklist is empty.", LogType.REQUEST, True)
    ...
    def _exit(self):
        ...
        print("\n")
        self.running = False
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "Exiting menu.", LogType.REQUEST, True)
    ...
    def _view_shared_key(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The shared key has been generated successfully.", LogType.KEY_GENERATION, True)
        bold = '\033[1m'
        underline = '\033[4m'
        reset = '\033[0m'
    ...
    def register_or_update_shared_key_by_yp(self):
        ...
        self.access_coordinator.management_logs.log_message(ComponentType.MENU, "The shared key has been registered or updated successfully.", LogType.KEY_GENERATION, True)
